                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="mb-8">
                            <div class="flex flex-col md:flex-row md:items-center justify-between bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-6 text-white">
                                ...
                                @include('admin.data.b2b.B2b_export')
                            </div>

                            <!-- Formulaire d'import -->
                            @include('admin.data.b2b.B2b_import')
                            

                            <!-- Système de filtrage avec colonnes -->
                            @include('admin.data.b2b.filtrage')
                            
                        </div>

                        {{-- chercher --}}
                        @include('admin.data.b2b.recherch')
                       
                        <!-- Table des données -->
                        @include('admin.data.b2b.list')
