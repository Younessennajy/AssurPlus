                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="mb-8">
                            <div class="flex flex-col md:flex-row md:items-center justify-between bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-6 text-white">
                                ...
                                <?php echo $__env->make('admin.data.b2b.B2b_export', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <!-- Formulaire d'import -->
                            <?php echo $__env->make('admin.data.b2b.B2b_import', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            

                            <!-- Système de filtrage avec colonnes -->
                            <?php echo $__env->make('admin.data.b2b.filtrage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            
                        </div>

                        
                        <?php echo $__env->make('admin.data.b2b.recherch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                       
                        <!-- Table des données -->
                        <?php echo $__env->make('admin.data.b2b.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
