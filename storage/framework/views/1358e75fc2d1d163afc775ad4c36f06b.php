    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg flex">
                ...
                <!-- Main Content -->
                <div class="p-4">
                    <h1 class="text-xl font-semibold mb-4">Modifier mes information</h1>
                    <?php if(session('success')): ?>
                        <div class="bg-green-100 text-green-800 p-2 rounded mb-4"><?php echo e(session('success')); ?></div>
                    <?php endif; ?>
                
                    <form action="<?php echo e(route('admin.profile.update', $admin->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\gestion_contrat\resources\views/admin/profile/profile.blade.php ENDPATH**/ ?>