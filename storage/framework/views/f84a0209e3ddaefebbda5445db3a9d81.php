                            ...
                            <div class="bg-white rounded-lg shadow">
                                <div class="border-b">
                                    <nav class="-mb-px flex">
                                        <a href="<?php echo e(route('admin.pays.b2b', $pays->name)); ?>" method="POST" 
                                        ...
                                        <a href="<?php echo e(route('admin.pays.b2c', $pays->name)); ?>" method="POST" 
                                ...
                                <?php if(!isset($excelHeaders)): ?>
                                    <form action="<?php echo e(route('admin.import.readHeaders', ['pays' => $pays->name, 'type' => $type])); ?>" 
                                          method="POST" 
