                        ...
                        <form action="<?php echo e(route('admin.import.process')); ?>" method="POST" class="p-6">
                            ...
                            <div class="mt-6 flex justify-end">
                                <div class="mt-6 flex justify-between">
                                    <form action="<?php echo e(route('admin.import.check_duplicates')); ?>" method="POST" class="mr-2">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="pays_id" value="<?php echo e($pays->id); ?>">
                                        <button type="submit" 
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\gestion_contrat\resources\views\admin\data\show.blade.php ENDPATH**/ ?>