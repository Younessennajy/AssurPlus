                ...
                <main class="p-6 w-full overflow-hidden">
                    ...
                    <div class="container mx-auto">
                        <div class="mb-8">
                            ...
                            <?php echo $__env->make('admin.data.b2c.b2c_export', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                
                            </div>

                            <!-- Formulaire d'import -->
                            <?php echo $__env->make('admin.data.b2c.b2c_import', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            

                            <!-- Formulaire de recherche -->
                            <?php echo $__env->make('admin.data.b2c.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            
                        </div>

                        <!-- Table Container avec scroll horizontal -->
                        <?php echo $__env->make('admin.data.b2c.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
