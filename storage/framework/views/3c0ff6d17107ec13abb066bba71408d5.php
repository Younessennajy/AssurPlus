                            ...
                            <?php if($type === 'b2b'): ?>
                                <div>
                                    ...
                                    <input type="text" id="raison_social" name="raison_social" 
                                        class="mt-1 block w-full rounded-md  shadow-sm focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['raison_social'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="dirigeant_prenom" name="dirigeant_prenom" 
                                        class="mt-1 block w-full rounded-md  shadow-sm focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['dirigeant_prenom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="dirigeant_name" name="dirigeant_name" 
                                        class="mt-1 block w-full rounded-md  shadow-sm focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['dirigeant_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Nouveau dossier\AssurPlus\resources\views\livewire\admin\data\edit_b2b.blade.php ENDPATH**/ ?>